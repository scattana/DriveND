...
# 05-DEC commented out these three lines below
#reading in an image
...
# 05-DEC added initializition to these two lines
    global avgLeft
    avgLeft = (0,0,0,0)
    global avgRight
    avgRight = (0,0,0,0)
...
def hough_lines(img, rho, theta, threshold, min_line_len, max_line_gap):
    ...
    location = draw_lines(line_img, lines)
    return (location, line_img)
...
# 05-DEC commented out two lines
#import os
#os.listdir("test_images/")

# Import everything needed to edit/save/watch video clips
# 05-DEC commented out one line
...
def process_image(image):
    ...
    location, lineMarkedImage = hough_lines(regionInterestImage, 1, np.pi/180, 40, 30, 200)
    ...
    # return both unmarked and marked lane detection image
    return (location, weighted_img(lineMarkedImage, image), image)     

# debug on images

# 05-DEC commented out all lines below
